...
function(validate_serial) {
  validate_serial = validate_serial || {};
...
var Module = typeof validate_serial != 'undefined' ? validate_serial : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_validate')) {
        Object.defineProperty(Module['ready'], '_validate', { configurable: true, get: function() { abort('You are getting _validate on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_validate', { configurable: true, set: function() { abort('You are setting _validate on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'serial.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('serial.wasm', import.meta.url).toString();
}
...
Module['onRuntimeInitialized'] = function () {
    ...
    Module['validate'] = cwrap('validate', 'number', ['string']);
}

  return validate_serial.ready
}
);
})();
export default validate_serial;