        ...
        private class Validate : ProgramBasedCommand
        {
            ...
            private int OnExecute(IConsole console)
            {
                ...
                try
                {
                    ...
                    console.WriteLine($" -> {program.Methods.Count()} methods");
                    console.WriteLine($" -> {program.Methods.SelectMany(m => m.Parameters).Count()} parameters");
                    console.WriteLine($" -> {program.Methods.SelectMany(m => m.Locals).Count()} locals");
                    console.WriteLine($" -> {program.Methods.SelectMany(m => m.Markers).Count()} markers");
                    console.WriteLine($" -> {program.Methods.SelectMany(m => m.Operations).Count()} operations");
                    program.Validate();
